...
Pour créer un nouveau domaine, nous devons définir ce serveur en tant que *Domain Controller*. En suivant le wizard de configuration, cocher `Add a new forest` et entrer le nom de domaine choisi.
